...
urlpatterns = [
    ...
    path('home-cards/', views.DashboardHomeCardsListView.as_view(), name='home_cards_list'),
    path('home-cards/create/', views.DashboardHomeCardSaveView.as_view(), name='home_card_create'),
    path('home-cards/<int:pk>/edit/', views.DashboardHomeCardSaveView.as_view(), name='home_card_edit'),
    path('home-cards/<int:pk>/delete/', views.DashboardHomeCardDeleteView.as_view(), name='home_card_delete'),
